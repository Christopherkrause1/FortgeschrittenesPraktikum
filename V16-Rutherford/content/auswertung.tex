...
ideale Gasgleichung $pV = N k_{\mathrm{B}} T$ verwendet. Hierbei ist $V= \SI{101e-3}{\meter}$ der Abstand von Quelle und Detektor, $N=\SI{6.022e23}{}$ die Teilchenzahl,
$k_{\mathrm{b}}$ die Boltzmann-Konstante und $T$ die Temperatur, hier die
Raumtemperatur.
Für den Kammerdruck gilt:
\begin{align*}
  p = \SI{241.3}{\milli\bar}
\end{align*}
