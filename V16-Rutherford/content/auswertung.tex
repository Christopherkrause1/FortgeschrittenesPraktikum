...
Mit der Massenzahl $A$, der Dichte von Gold $\rho_{\symup{Au}}$ und der atomaren Masseneinheit $u$.
...
angegeben. $N$ bezeichnet dabei die in einem der vorherigen Abschnitte bereits erwähnte Teilchendichte des entsprechenden Elements.
